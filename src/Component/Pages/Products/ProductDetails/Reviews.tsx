      ...
      <section className="py-24 relative">
        <div className="w-full max-w-7xl px-4 md:px-5 lg:px-6 mx-auto">
          <div className="">
            ...
            <div className="grid grid-cols-12 mb-11 p-4 bg-gray-100 ">
              ...
              <div className="col-span-12 max-xl:mt-8 xl:col-span-8 xl:pl-8 w-full  min-h-[230px]">
                <div className="grid grid-cols-12 h-full px-8 max-lg:py-8 rounded-3xl  w-full max-xl:max-w-3xl max-xl:mx-auto">
              ...
              {[1, 2, 3].map((item, index) => (
                <div className="mt-8">
                  ...
                  <p className="font-normal text-lg leading-8 text-gray-500 ">
                    ...
                    features with a robust set of design components, making it a
                    go-to for creating visually stunning and consistent
                    interfaces.
                  </p>
                </div>
              ))}
